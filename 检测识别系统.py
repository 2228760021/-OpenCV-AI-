...
class CoreUI(QMainWindow):
    ...
    def __init__(self):
        ...
        #     lambda: webbrowser.open('https://www.bilibili.com/video/BV1Lq4y1Z7dm'))
        # self.contactDeveloperButton.clicked.connect(lambda: webbrowser.open('https://space.bilibili.com/38061207'))
